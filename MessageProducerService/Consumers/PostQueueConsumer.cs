...
{
    public class PostQueueConsumer : BackgroundService
    {
        protected readonly IRabbitMqConnection _rabbitMqConnection;
        private readonly IServiceScopeFactory _serviceScopeFactory;

        public PostQueueConsumer(IRabbitMqConnection rabbitMqConnection, IServiceScopeFactory serviceScopeFactory)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            await channel.QueueDeclareAsync(queue: "post",
                durable: true,
                exclusive: false,
                autoDelete: false,
                arguments: null);
            ...
            await channel.BasicConsumeAsync(queue: "post",
                autoAck: false,
                consumer: consumer);
        }
    }
